...
func (sched *Scheduler) scheduleOne(ctx context.Context) {
	...
	klog.Infof("TraceID propagation test scheduler.go start request-id %s", request_id)
	...
	klog.Infof("ScheduleOne pod TraceID request-id: %s", request_id)
	klog.Infof("TraceID propagation test scheduler.go end")
